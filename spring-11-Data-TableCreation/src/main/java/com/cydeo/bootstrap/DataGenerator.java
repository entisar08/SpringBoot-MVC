...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Car c3=new Car("TOYota", "Corrolla");
        // I want to save c1 , c2, c3 in db

        //do we have method doing the saving for me? yes in jparepository
        //since you want to use car repository her you need to inject it by :
        //flagging the class by @ component
        // create an final field  of that class to force you to build constructor
